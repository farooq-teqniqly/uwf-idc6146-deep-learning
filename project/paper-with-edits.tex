...
This project was completed solely by\textbf{Farooq Mahmud}. All tasks, including the implementation of the TensorFlow code for the GoogLeNet model, data pre-processing, model training and testing, development of the simple sequential model, model evaluation, and writing of the report, were conducted independently.}
